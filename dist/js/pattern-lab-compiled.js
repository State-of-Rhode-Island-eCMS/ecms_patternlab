...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var modalName = 'modal_accept' + element.getAttribute('data-nid'); // Checks for cookie, displays modal if not present.

  if (!getCookie(modalName)) {
    MicroModal.show('modal-1'); // Set cookie on close of modal.
