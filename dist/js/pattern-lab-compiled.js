...
!function (t, e) {
  ...
  return r = {}, i.m = n = [function (t, e, n) {
    ...
    ***************************************************************************** */
    ...
    function R(t) {
      for (var e = [], n = "", r = Object.keys(t), i = Object.keys(dt), a = 0; a < r.length; a++) {
    ...
    function et(t, e) {
      ...
      if (f) {
        ...
        if (Object(x.c)(e.byweekno, k)) for (O = 0; O < f; O++) {
          l.wnomask[O] = 1;
        }
      }
    ...
    var rt = (nt.prototype.rebuild = function (t, e) {
        ...
        this.monthinfo = function (t, e, n, r, i, a) {
          var o = {
            ...
            nwdaymask: []
              ...
              s = [];
          if (a.freq === ft.YEARLY) {
            if (Object(x.b)(a.bymonth)) s = [[0, n]];else for (var u = 0; u < a.bymonth.length; u++) {
          ...
          for (o.nwdaymask = Object(x.l)(0, n), u = 0; u < s.length; u++) {
            for (var c = s[u], h = c[0], d = c[1] - 1, y = 0; y < a.bynweekday.length; y++) {
              var l = void 0,
                  f = a.bynweekday[y],
                  b = f[0],
                  p = f[1];
      ...
      for (var r = this.mrange[e - 1], i = this.mrange[e], a = Object(x.l)(null, this.yearlen), o = r; o < i; o++) {
        a[o] = o;
      }
    ...
    var a = (i.isFullyConvertible = function (t) {
      ...
      return n ? function (t, e, n) {
        for (var r = "", i = 0; i < t.length; i++) {
          0 !== i && (i === t.length - 1 ? r += " " + n + " " : r += e + " "), r += t[i];
        }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var modalName = 'modal_accept' + contentModal.getAttribute('data-nid'); // Checks for cookie, displays modal if not present.
  ...
  if (!getCookie(modalName)) {
    ...
    if (homescreen && mobileCheck()) {
      ...
      homescreen.classList.remove('qh__modal-homescreen--closed'); // Disable content modal.
      ...
      closeHomescreenModal.addEventListener('click', function (event) {
        ...
        contentModal.classList.remove('qh__modal--disabled'); // Hide homescreen modal.

        homescreen.classList.add('qh__modal-homescreen--closed');
      });
    }

    MicroModal.show('modal-content'); // Set cookie on close of modal.
